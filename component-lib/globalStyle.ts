...
export const popUp = {
  "pop-up-style":
    "w-full absolute overflow-y-auto border border-gray-300 px-2 rounded-lg mt-[1px] scrollbar bg-white z-50 scrollbar h-auto animate-fade-down animate-once animate-duration-200",
};
